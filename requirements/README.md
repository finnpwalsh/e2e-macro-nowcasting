...
- `services/*.txt` – long-running service deps
...
- Airflow and MLflow use a separate runtime (official `apache/airflow` image for Airflow) and keeps deps isolated in `runtimes/services/*airflow*.txt`
